    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('user-management.index') }}"><i class="fa fa-link"></i> <span>User management</span></a></li>
         <li><a href="{{ url ('ajax/') }}"><i class="fa fa-link"></i> <span>Task</span></a></li>
      <li><a href="{{ url ('learn/') }}"><i class="fa fa-link"></i> <span>learn</span></a></li>
      <li><a href="{{ url ('jquery/') }}"><i class="fa fa-link"></i> <span>Jquery</span></a></li>
