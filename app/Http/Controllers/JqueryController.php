...
/*---------------------------------Show Datatable function---------------------------------------*/	
			...
			$learns = DB::table('learns')->select('id as select','id','fname','lname', 'cno','email','address');
      ...
      $data->editColumn('select', function($learn) {
        return '<input type="checkbox" value='. $learn->id .'>';
    });          
