...
*/
			...
			$learns = DB::table('learns')->join('roles', 'learns.role_id', '=', 'roles.id')->select('learns.id','learns.fname','learns.lname', 'learns.cno','learns.email','learns.address','learns.role_id','roles.name as role','learns.created_at');
      $data=Datatables::of($learns);
      $data->addColumn('action', function ($learn) {
